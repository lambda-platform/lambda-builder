    ...
    >
        ...
        <div class="clickable sortDiv">
            ...
            <div class="menu-control">
                <span>&nbsp;</span>
                <span v-if="data.url === '/plan'">
                  <Checkbox :disabled="!permissions[data.id].show" v-model="permissions[data.id].c"
                  >Нэмэх</Checkbox>
                </span>
        ...
        <div v-if="extend" class="user-data">
            ...
            <Row v-if="permissions[data.id].u">
                <Col>
                    ...
                    <query-builder @change="changeFilter" @changeValueByJS="changeFilterJS"
                                   v-if="grid_fields_full.length >= 1"
                                   :query="permissions[data.id].gridEditConditionSQL"
                                   :fields="grid_fields_full"></query-builder>
                </Col>
            </Row>
            <Row v-if="permissions[data.id].d">
                <Col>
                    ...
                    <query-builder @change="changeDeleteFilter" @changeValueByJS="changeDeleteFilterJS"
                                   v-if="grid_fields_full.length >= 1"
                                   :query="permissions[data.id].gridDeleteConditionSQL"
                                   :fields="grid_fields_full"></query-builder>
                </Col>
            </Row>
