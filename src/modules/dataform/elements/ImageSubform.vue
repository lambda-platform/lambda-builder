<template>
    <div class="subform-image-wrapper">
        <Upload
            ...
            :on-success="success">
            <Button type="dashed">
                <img class="preview-img subform-img-preview" v-if="this.model.form[this.model.component] != null"
                     :src="`${(cdn && cdn.remote) ? cdn.host : ''}${this.model.form[this.model.component]}`"
                     alt="image">
                <div>
