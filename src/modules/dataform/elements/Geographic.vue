    ...
    <FormItem :label=label :prop=rule>
        <div class="geographic">
            ...
            <div id="side_bar" :class="openSide ? 'open' : ''">
                ...
                <Button type="success" @click="saveGraphic">{{
                        `${$static_words ? $static_words.save : 'Хадгалах'}`
                    }}
                </Button>
                <Button type="warning" @click="cancelGraphic">
                    {{ `${$static_words ? $static_words.cancel : 'Болих'}` }}
                </Button>
...
// this.clearSearchLayer();
        ...
        geometrySelectEvent(e) {
            if (this.meta && this.meta.disabled) {} else {
