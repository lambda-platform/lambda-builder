...
export const ICON = {
    ...
    rotateLeft: '<polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/>',
    ...
    pdf: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><text x="5.2" y="18" font-size="6.5" font-weight="700" fill="currentColor" stroke="none">PDF</text>',
    wordDown: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><text x="7.6" y="13.5" font-size="7.5" font-weight="700" fill="currentColor" stroke="none">W</text><path d="M12 15.5v4"/><path d="m9.8 17.7 2.2 2.2 2.2-2.2"/>',
    flipH: '<line x1="12" y1="2" x2="12" y2="22" stroke-dasharray="2.5 2.5"/><path d="M9 7L4 12l5 5z" fill="currentColor" stroke="none"/><path d="M15 7l5 5-5 5z"/>',
    flipV: '<line x1="2" y1="12" x2="22" y2="12" stroke-dasharray="2.5 2.5"/><path d="M7 9l5-5 5 5z" fill="currentColor" stroke="none"/><path d="M7 15l5 5 5-5z"/>',
