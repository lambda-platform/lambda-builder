    ...
    <div class="login">
        <div class="content">
            ...
            <div class="header">
                <div class="logo">
                    <div class="title">
                        <h2 style="max-width: 600px; margin-bottom: 10px !important;">Talked</h2>
                        <p>Talking education system</p>
                    </div>
                </div>
            ...
            <div class="content-body">
                <div class="lottie">
                    <lottie-animation path="assets/app/login-bg.json"/>
                </div>
            </div>
...
<style lang="scss">
@import "../../../scss/theme/talked/style";
</style>
