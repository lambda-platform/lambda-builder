<template>
    <div class="login">
        <div class="content">
            ...
            <div class="header">
                <div class="logo">
                    <img src="/assets/logistic/images/logo-horz.png" alt="logo" style="height: 32px"/>
                    <div class="title">
                        <p>Тээврийн нэгдсэн мэдээллийн платформ</p>
                    </div>
                </div>
            ...
            <div class="content-body">
                <div class="lottie">
                    <lottie-animation path="assets/logistic/bg2.json"/>
                </div>
            </div>
...
<style lang="scss">
@import "../../../scss/theme/e-logistic/style";
</style>
