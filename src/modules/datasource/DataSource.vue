    ...
    <div class="data-source">
        <div class="data-source-sidebar">
            <div class="data-source-header">
                <h3>
                    <Button shape="circle" size="small" icon="md-arrow-back"></Button>
                    {{ lang . dataProcessing }}
                </h3>
            </div>
            <div class="data-source-sidebar-wrapper">
                <div class="field-editor">
                    <h5 class="ve-title" style="font-size: 12px">{{ lang.characteristics }}</h5>
                    <Tabs :value="properties" @on-click="changeTab">
                        <TabPane :label="lang.basic" name="main">
                            <div>
                                <Input v-model="viewName" :placeholder="lang.name" size="small" class="table-col-search"></Input>
                                <br>
                                <br>
                                <Input v-model="extraQuery" :placeholder="lang.additional + ' ' + 'query'" size="small" class="table-col-search"></Input>
                                <br>
                                <br>
                                <Checkbox v-model="withFilter" @on-change="doFilter">
                        ...
                        <TabPane :label="lang.column" name="field">
                            <div>
                                <table>
                                    <tr>
                                        <td>{{lang.aggregation}}:</td>
                                        <td>
                                            <Select v-model="field.aggregate" size="small" style="width:100px" :placeholder="lang.select">
                                    ...
                                    <tr>
                                        <td>{{lang.sort}}:</td>
                                        <td><Select v-model="field.sortType" size="small" style="width:100px" :placeholder="lang.select">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <Checkbox v-model="field.output" size="small">{{ lang.use }}</Checkbox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <Checkbox v-model="field.groupBy" size="small">{{ lang.grouping }}</Checkbox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{lang.name}}:</td>
                                        <td><Input v-model="field.name" disabled size="small" class="table-col-search"></Input></td>
                                    </tr>
                                    <tr>
                                        <td>{{lang.type}}:</td>
                                        <td>
                                            <Input v-model="field.dbType" disabled size="small"
                                                   class="table-col-search"></Input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{lang.alias}}:</td>
                                        <td>
                                            <Input :disabled="!field.output" v-model="field.alias_db" placeholder=""
                                                   size="small" class="table-col-search"></Input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{lang.sort}} #:</td>
                                        <td>
                                            <InputNumber :min="1" :disabled="field.sortType == 'none'"
                                                         v-model="field.sortOrder" type="number" size="small"
                                                         class="table-col-search"></InputNumber>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{lang.grouping}} #:</td>
                                        <td>
                                            <InputNumber :min="1" :disabled="!field.groupBy" v-model="field.groupOrder"
                ...
                <div class="table-selector">
                    <h5 class="ve-title" style="font-size: 12px"> {{lang.bolomjitTableAndView}}</h5>
                    <br>
                    <h5>{{ lang.tableList }}</h5>
                    <Button
                        icon="ios-list"
        ...
        <div class="data-source-workspace">
            ...
            <div class="data-source-wrapper" id="data-source-editor">
        ...
        saveSchema () {
            ...
            axios.post(submitUrl, data).then(o => {
                if (o.data.status) {
                    ...
                    this . $Message . info ( "An error occurred while saving! " );
                }
            });
        },
        init() {
                ...
                if (fields.length >= 1) {
                    ...
                    if (!ignoreError)
                        this.$Message.warning(
                            " From the table, there are no columns "
                        );
                    jQuery("#builder").queryBuilder("destroy");
                }
            } else {
